...
//para la textura de dado animales 
Texture dadoAnimales;

//textura del dado 10 caras
Texture dadoDiez;
...
//para el modelo de dados animales 
Model dadoAnimales_M;


//Para el caso del coche
Model AutoSinLlantasSinCofre_M;
Model AutoLlantaTraseraIzquierda_M;
Model AutoLllantaTraseraDerecha_M;
Model AutoCofre_M;
Model AutoLlantaDelanteraDerecha_M;
Model AutoLlantaDelanteraIzquierda_M;
...
// average normals
	GLfloat cubo_vertices[] = {
		...
		-2.13f, 1.81f,  0.0f,	0.443f,	0.533f,		0.0f,	0.0f,	1.0f,	//1
		-2.16f, -2.5f,  0.0f,	0.537f,	0.533f,		0.0f,	0.0f,	1.0f,	//2

		0.79f, -0.22f,  -3.0f,	0.635f,  0.663f,	0.0f,	0.0f,	1.0f,
		-2.16f, -2.5f,  0.0f,	0.588f,	0.583f,		0.0f,	0.0f,	1.0f,
		1.92f, -3.85f,  0.0f,	0.682f,	0.583f,		0.0f,	0.0f,	1.0f,
		...
		4.48f, -0.39f,  0.0f,	0.526f,	0.805f,		0.0f,	0.0f,	1.0f,
		1.99f, 3.0f,	0.0f,	0.618f,	0.805f,		0.0f,	0.0f,	-1.0f,
...
// average normals
	...
	Mesh* dado = new Mesh();
	dado->CreateMesh(cubo_vertices, cubo_indices, 192, 36);//30 INDICES
	meshList.push_back(dado);
...
int main()
{
	...
	//Para el cubo de animales 
	dadoAnimales = Texture("Textures/animal.tga");
	...
	//parte del modelo del cubo de animales
	dadoAnimales_M = Model();
	dadoAnimales_M.LoadModel("Models/cuboAnimalCopia.fbx");
	//dadoAnimales_M.LoadModel("Models/cuboAnimal.obj");


	//Para el automovil 
	AutoSinLlantasSinCofre_M = Model();
	AutoSinLlantasSinCofre_M.LoadModel("Models/AutoSinLlantasSinCofre.obj");

	AutoLlantaTraseraIzquierda_M = Model();
	AutoLlantaTraseraIzquierda_M.LoadModel("Models/AutoLlantaTraseraIzquierda.obj");
	AutoLllantaTraseraDerecha_M = Model();
	AutoLllantaTraseraDerecha_M.LoadModel("Models/AutoLlantaTraseraDerecha.obj");
	AutoCofre_M = Model();
	AutoCofre_M.LoadModel("Models/AutoCofre.obj");
	AutoLlantaDelanteraDerecha_M = Model();
	AutoLlantaDelanteraDerecha_M.LoadModel("Models/AutoLlantaDelanteraDerecha.obj");
	AutoLlantaDelanteraIzquierda_M = Model();
	AutoLlantaDelanteraIzquierda_M.LoadModel("Models/AutoLlantaDelanteraIzquierda.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		/*
		model = glm::mat4(1.0);
		//Color del automovil en este caso es azul
		...
		//atras
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, (mainWindow.getRotacioPositivaLlantas()) / 100));
		//delante
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, (mainWindow.getRotacioNegativaLlantas()) / 100));

		modelaux = model;

		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoSinLlantasSinCofre_M.RenderModel();

		//Cofre automovil
		model = modelaux;
		color = glm::vec3(0.0f, 1.0, 1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getAnguloCofre()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoCofre_M.RenderModel();

		//Llanta trasera derecha
		model = modelaux;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.7f, -0.43f, 1.15f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioPositivaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioNegativaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoLllantaTraseraDerecha_M.RenderModel();

		//Llanta trasera izquierda
		model = modelaux;
		color = glm::vec3(0.0f, 0.0f, 0.0f);//llantas color negro
		model = glm::translate(model, glm::vec3(-0.7f, -0.43f, 1.15f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioPositivaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioNegativaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoLlantaTraseraIzquierda_M.RenderModel();

		//Llanta delantera derecha
		model = modelaux;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.7f, -0.43f, -1.18f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioPositivaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRotacioNegativaLlantas()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoLlantaDelanteraDerecha_M.RenderModel();
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		AutoLlantaDelanteraIzquierda_M.RenderModel();
		*/
