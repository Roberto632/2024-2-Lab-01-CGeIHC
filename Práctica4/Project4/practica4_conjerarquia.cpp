...
int main()
{
	...
	//Puse el valor de 10 para contemplar mejor el movimiento de las llantas
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//RUEDA TRASERA IZQ
		modelaux = model;
		model = glm::translate(model, glm::vec3(-3.4f, 1.3f, -6.6f));
		...
		//RUEDA DELANTERA IZQ
		modelaux = model;
		model = glm::translate(model, glm::vec3(-3.4f, 1.3f, -1.4f));
		model = glm::scale(model, glm::vec3(1.2f, 1.2f, 1.2f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		*/
		...
		//CUELLO
		modelaux = model;
		model = glm::translate(model, glm::vec3(-5.0f, 5.3f, -4.0));
		...
		//CABEZA
		modelaux = model;
		model = glm::translate(model, glm::vec3(-6.0f, 10.5f, -4.0));
		...
		//OCICO
		modelaux = model;
		model = glm::translate(model, glm::vec3(-11.0f, 9.0f, -4.0));
		...
		// Articulacion 1
		modelaux = model;
		model = glm::translate(model, glm::vec3(5.0f, -3.0f, -1.0f)); // Posicion de  pierna
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Para que la pierna mire para abajo
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f)); // rotación alrededor de la articulación 
		...
		// Articulacion 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(5.0f, -3.0f, -7.0f)); // Posicion de  pierna
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Para que la pierna mire para abajo
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f)); // rotación alrededor de la articulación 
		// Parte superior de la pierna
		model = glm::translate(model, glm::vec3(-1.0f, 2.0f, 0.0f)); // Posicion parte superior
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		...
		//PIERNA DELANTERA IZQ
		// Articulacion 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-4.0f, -3.0f, -7.0f)); // Posicion de  pierna
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Para que la pierna mire para abajo
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f)); // rotación alrededor de la articulación 
		// Parte superior de la pierna
		model = glm::translate(model, glm::vec3(-1.0f, 2.0f, 0.0f)); // Posicion parte superior
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		...
		//PIERNA DELANTERA DER
		// Articulacion 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-4.0f, -3.0f, -1.0f)); // Posicion de  pierna
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Para que la pierna mire para abajo
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f)); // rotación alrededor de la articulación 
		// Parte superior de la pierna
		model = glm::translate(model, glm::vec3(-1.0f, 2.0f, 0.0f)); // Posicion parte superior
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		...
		// Articulacion 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(7.0f, 2.0f, -3.0f)); // Posicion de  cola
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f)); // Para que la cola este inclinada
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(1.0f, 0.0f, 0.0f)); // rotación alrededor de la articulación 
